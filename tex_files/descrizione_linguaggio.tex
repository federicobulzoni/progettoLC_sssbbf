...
I tipi degli operatori binari sono descritti in tabella \ref{tab:binari}, i tipi degli operatori unari sono descritti in tabella \ref{tab:unari}.
...
\begin{table}[h]
	...
	\end{tabular}
	\caption{Tabella con i tipi degli operatori unari.}
	\label{tab:unari}
\end{table}
