...
newtype PBreak = PBreak (Loc,Ident)
  deriving (Eq, Ord, Show, Read)

newtype PContinue = PContinue (Loc,Ident)
  deriving (Eq, Ord, Show, Read)
...
data ParamClause = PParam [Param]
  deriving (Eq, Ord, Show, Read)

data Param = DParam ParamPassMod PIdent TypeSpec
  deriving (Eq, Ord, Show, Read)
...
data Stm
    ...
    | SIfElse Exp Stm Stm
    | SDoWhile Stm Exp
    | SFor PIdent Exp Exp Exp Stm
    | SReturn PReturn
    | SReturnExp PReturn Exp
    | SProcCall PIdent [Args]
    | SContinue PContinue
    | SBreak PBreak
  deriving (Eq, Ord, Show, Read)
...
data Exp
    ...
    | ENull PNull
    | EArray [Exp]
    | EFunCall PIdent [Args]
    | EIfElse Exp Exp Exp
    | ExpTyped Exp TypeSpec Loc
    | EOp Exp Op Exp
  deriving (Eq, Ord, Show, Read)
