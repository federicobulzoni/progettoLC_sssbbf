...
instance Print AbsGramm.Block where
  prt i e = case e of
    ...
    AbsGramm.BlockTyped block typespec loc -> prPrec i 0 (concatD [doc (showString "["), prt 0 block, doc (showString ":"), prt 0 typespec, doc (showString ":"), prt 0 loc, doc (showString "]")])
...
instance Print AbsGramm.Op where
  prt i e = case e of
    ...
    AbsGramm.Minus -> prPrec i 4 (concatD [doc (showString "-")])
    AbsGramm.Prod -> prPrec i 5 (concatD [doc (showString "*")])
    AbsGramm.Div -> prPrec i 5 (concatD [doc (showString "/")])
    AbsGramm.Mod -> prPrec i 5 (concatD [doc (showString "%")])
    AbsGramm.Pow -> prPrec i 6 (concatD [doc (showString "^")])
...
instance Print AbsGramm.Exp where
  prt i e = case e of
    ...
    AbsGramm.ETyped exp typespec loc -> prPrec i 0 (concatD [doc (showString "["), prt 0 exp, doc (showString ":"), prt 0 typespec, doc (showString ":"), prt 0 loc, doc (showString "]")])
  prtList _ [] = concatD []
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]
...
instance Print AbsGramm.Stm where
  prt i e = case e of
    ...
    AbsGramm.SAssign lexp exp -> prPrec i 0 (concatD [prt 0 lexp, doc (showString "="), prt 0 exp])
    AbsGramm.SWhile exp stm -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 exp, doc (showString ")"), prt 0 stm])
    AbsGramm.SIf exp stm1 stm2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), prt 0 stm1, doc (showString "else"), prt 0 stm2])
    AbsGramm.SReturn preturn -> prPrec i 0 (concatD [prt 0 preturn])
    AbsGramm.SReturnExp preturn exp -> prPrec i 0 (concatD [prt 0 preturn, prt 0 exp])
    AbsGramm.StmTyped stm typespec loc-> prPrec i 0 (concatD [doc (showString "["), prt 0 stm, doc (showString ":"), prt 0 typespec, doc (showString ":"), prt 0 loc, doc (showString "]")])
  prtList _ [] = concatD []
  prtList _ [] = concatD []
  prtList _ [] = concatD []
  prtList _ [] = concatD []
...
instance Print AbsGramm.LExp where
  prt i e = case e of
    ...
    AbsGramm.LIdentTyped pident typespec loc -> prPrec i 0 (concatD [doc (showString "["), prt 0 pident, doc (showString ":"), prt 0 typespec, doc (showString ":"), prt 0 loc, doc (showString "]")])
